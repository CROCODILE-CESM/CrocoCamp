...
After running the demo, you can explore the results using the provided Jupyter notebooks in the `tutorials/` folder.
- This notebook demonstrates how to load and visualize the parquet datasets generated by `perfect-model-obs`
- It provides examples of comparing model and observation data using interactive widgets, including diagnostic values such as:
  - `residual` (obs - model)
