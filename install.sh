...
echo 'export PYTHONPATH="/glade/u/home/emilanese/work/DART-Derecho/observations/obs_converters/CrocoLake:\$PYTHONPATH"' >> $CONDA_ENV_PATH/etc/conda/activate.d/set_pythonpath.sh
